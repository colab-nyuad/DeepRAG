...
from query_expansion_ola import Query
...
def main():
    ...
    for i, item in enumerate(input_data):
        ...
        # Rerank with SPLADE
        print(f"Reranking {len(clean_docs)} documents using SPLADE...")
        ...
        print(f"Selected {len(reranked_docs)} documents")
        ...
        # Generate answer
        query_obj = Query(original_query=question, expanded_queries=[])
